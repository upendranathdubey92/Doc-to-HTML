#!/usr/bin/env python3
"""
Create a test Word document for the content update tool
"""
...
def create_test_document():
    ...
    # Add sample content with section labels
    content = [
        "[HERO]",
    ...
    # Save the document
    doc.save('/home/sotsys-252/Desktop/page-content-update/test_document.docx')
